...
import com.jy.common.constants.util.EncodeConstant;
import com.jy.common.exception.file.FileReadException;
import com.jy.common.exception.file.FileSizeOutException;
...
public class FileUtils implements EncodeConstant {
    ...
    public static StringBuffer getFileContent(File file) throws FileNotFoundException {
        ...
        try {
            ...
            BufferedReader reader = new BufferedReader(new InputStreamReader(bufferIn,UTF_8),CACHE_SIZE);
            String line;
    ...
    public static File getFile(URL resourceUrl, String description) throws FileNotFoundException {
        Assert.notEmpty(resourceUrl, "Resource URL must not be null");
